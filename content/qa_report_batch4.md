...
- ID range: `et_0100-pt_0133`
- Questions in batch: 280
- Bank: `content/questions.sample.json`
- Generated: 2026-04-21
- Subset for agents: `content/qa_batch4_subset.json`
...
```
Structural Validation: 379 questions
...
```
Dedupe Check: 280 new IDs against 379 total
...
against `content/qa_batch4_subset.json`, then paste the findings
